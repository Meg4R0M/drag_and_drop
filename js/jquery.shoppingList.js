...
(function($){
	$.fn.shoppingList = function(options) {
		...
		this.each(function(){
			...
			$(obj).after("<div class='trash'>Poubelle</div>");
			// On ajoute un petit formulaire pour ajouter des items
			$(obj).after("<div class='add'><input class='addValue' /> <input type='button' value='Ajouter' class='addBtn' /></div>");
			...
			$(".trash").droppable({
				...
				over: function(event, ui){
					...
					$(this).text("Supprimer "+ui.draggable.find(".item").text());
